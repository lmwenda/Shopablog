    ...
    return (
        ...
        <header className='flex border-b py-3 px-3 sm:px-10 bg-white font-[sans-serif] min-h-[65px] tracking-wide relative z-50 bg-white-500 '>
            ...
            <div className='flex ml-auto'>
                <div
                className='flex max-w-xl w-full bg-gray-100 px-24 py-2 rounded outline outline-transparent border focus-within:border-blue-600 focus-within:bg-transparent transition-all'>
