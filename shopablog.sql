...
Values ("New AAA Game Dropped...", "Its going crazy in the commmunity", "You need to play this game asap...", 1),
	("National Minimum Wages has now increased...", "From April 2025 the Government will change the minimum wages", "This is now changing the game", 3),
    ("Skyrim after 10 Years is still Insane", "Its going crazy in the commmunity", "You need to play this game asap...", 1),
    ("A new fight between politicians", "Its going crazy in the court", "You need to watch this asap...", 3);
